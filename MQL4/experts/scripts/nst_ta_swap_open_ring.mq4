...
void start()
{
   ...
   if(CheckUsedMargin == true || MarginBudget > freemargin)
	    MarginBudget = (freemargin - AccountMargin() * 0.1) * 0.9;
	...
	while(checkmargin > MarginBudget && MarginBudget > 0)
	{
		lots = lots - lotstep;
		clots = lots * MarketInfo(Ring[RingIdx][2], MODE_BID);
